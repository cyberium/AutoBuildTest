...
# File slightly modified by Cyberium for CMaNGOS projects


set(AUTO_VCPKG_GIT_REPOSITORY "https://github.com/cmangos/vcpkg")
...
function (vcpkg_bootstrap)
    ...
    if (NOT AUTO_VCPKG_EXECUTABLE)
        execute_process(COMMAND ${CMAKE_COMMAND} -E copy "${CMAKE_CURRENT_LIST_DIR}/cmake/vcpkg/vcpkg-bootstrap.cmake" "${AUTO_VCPKG_ROOT}")
